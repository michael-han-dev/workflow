...
import * as workflow_0_workflow_only from './workflows/0_workflow_only';
import * as workflow_10_single_stmt_control_flow from './workflows/10_single_stmt_control_flow';
...
export const allWorkflows = {
  ...
  'workflows/0_workflow_only.ts': workflow_0_workflow_only,
  'workflows/10_single_stmt_control_flow.ts':
    workflow_10_single_stmt_control_flow,
