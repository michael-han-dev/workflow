---
title: SvelteKit
description: Set up Workflow DevKit with SvelteKit for durable, long-running functions.
---

<Intro framework="SvelteKit" />
...
```ts title="src/routes/api/signup/+server.ts" lineNumbers
