---
title: Next.js
description: Set up Workflow DevKit with Next.js for durable, long-running functions.
---

<GettingStartedIntro framework="Next.js" />
...
```ts title="app/api/signup/route.ts" lineNumbers
