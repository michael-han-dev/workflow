---
title: Nuxt
description: Set up Workflow DevKit with Nuxt for durable, long-running functions.
---

<GettingStartedIntro framework="Nuxt" />
...
```ts title="server/workflows/user-signup.ts" lineNumbers
