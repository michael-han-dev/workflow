...
```ts title="workflows/simple-streaming.ts" lineNumbers
...
```ts title="app/api/stream/route.ts" lineNumbers
...
```ts title="app/api/resume-stream/[runId]/route.ts" lineNumbers
...
```ts title="workflows/streaming.ts" lineNumbers
...
```ts title="workflows/bad-example.ts" lineNumbers
...
```ts title="workflows/good-example.ts" lineNumbers
...
```ts title="workflows/multi-stream.ts" lineNumbers
import { getWritable } from "workflow";
...
```ts title="app/api/multi-stream/route.ts" lineNumbers
import { start } from "workflow/api";
...
```ts title="workflows/batch-processing.ts" lineNumbers
...
```ts title="workflows/ai-assistant.ts" lineNumbers
...
```ts title="app/api/ai-assistant/route.ts" lineNumbers
...
```ts title="workflows/stream-pipeline.ts" lineNumbers
...
```ts title="workflows/file-processing.ts" lineNumbers
...
```ts title="workflows/stream-error-handling.ts" lineNumbers
