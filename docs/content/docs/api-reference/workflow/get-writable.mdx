...
- [`getRun()`](/docs/api-reference/workflow-api/get-run) - Get a workflow run object including the `readable` stream

## Learn More

- [Streaming](/docs/foundations/streaming) - Learn about streaming patterns in workflows
