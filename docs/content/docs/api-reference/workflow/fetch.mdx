...
- [`FatalError`](/docs/api-reference/workflow/fatal-error) - Prevent a step from retrying
- [`RetryableError`](/docs/api-reference/workflow/retryable-error) - Customize retry behavior with delay options
- [`sleep()`](/docs/api-reference/workflow/sleep) - Suspend a workflow for a duration
